...
values
  ('71000000-0000-0000-0000-000000000001', 'Morado', 'MOR', '#6A0DAD'),
  ('71000000-0000-0000-0000-000000000002', 'Azul', 'AZU', '#1E90FF'),
  ('71000000-0000-0000-0000-000000000003', 'Verde', 'VER', '#89CC04'),
  ('71000000-0000-0000-0000-000000000004', 'Rosa', 'ROS', '#FFB7C5'),
  ('71000000-0000-0000-0000-000000000005', 'Rojo', 'ROJ', '#DC143C'),
  ('71000000-0000-0000-0000-000000000006', 'Negro', 'NEG', '#0A0A0F')
...
with generated_posts(government_id, topic_name, title, body) as (
  ...
  ('MX-CHIH-GOB-MORADO-0001', 'Pueblos originarios', 'Propuesta sobre Pueblos originarios', 'Nuestros pueblos originarios siempre lo supieron: el tiempo es circular y la intuición es el lenguaje de los abuelos. Mi gobierno financiará la traducción de todos los manuales de misticismo a lenguas indígenas. Vamos a fusionar el beat del pop moderno con el tambor ancestral. ¡Porque la sabiduría no está en los libros, está en la sangre que sabe!'),
  ...
  ('MX-CHIH-GOB-AZUL-0002', 'Pueblos originarios', 'Propuesta sobre Pueblos originarios', 'Mis hermanos Raramuris son la raíz de nuestra fuerza. 🏔️ Mi gobierno no los va a ignorar jamás. Vamos a llevar caminos, agua y salud a lo más profundo de la sierra, pero respetando siempre su cultura y su lengua. Queremos que el mundo entero vea sus tejidos y su resistencia. Porque la Sierra es Chihuahua y Chihuahua es de todos. ¡Unidos por la sangre y la canción! #OrgulloRaramuri #SierraConJuanga #RaícesDeChihuahua'),
  ...
  ('MX-CHIH-DIPUTACIONLOCAL-CHIHUAHUALOCAL1-MORADO-0007', 'Pueblos originarios', 'Propuesta sobre Pueblos originarios', 'Levemente en desacuerdo'),
  ...
  ('MX-CHIH-DIPUTACIONLOCAL-CHIHUAHUALOCAL1-AZUL-0008', 'Pueblos originarios', 'Propuesta sobre Pueblos originarios', 'Extremadamente en desacuerdo'),
